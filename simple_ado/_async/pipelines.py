...
"""ADO pipeline API wrapper (async)."""
...
class ADOAsyncPipelineClient(ADOAsyncBaseClient):
    ...
    async def get_top_ten_thousand_runs(self, *, project_id: str, pipeline_id: int) -> ADOResponse:
    ...
    async def get_run(self, *, project_id: str, pipeline_id: int, run_id: int) -> ADOResponse:
        """Get a pipeline run.
