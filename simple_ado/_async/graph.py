...
class ADOAsyncGraphClient(ADOAsyncBaseClient):
    ...
    async def get_scope_descriptors(self, storage_key: str) -> ADOResponse:
    ...
    async def get_storage_key(self, subject_descriptor: str) -> ADOResponse:
    ...
    async def lookup_subjects(self, subject_descriptors: list[str]) -> list[Any]:
    ...
    async def list_groups(self, *, scope_descriptor: str | None = None) -> list[Any]:
    ...
    async def get_group(self, descriptor: str) -> ADOResponse:
        """Get the group
    ...
    async def get_user(self, descriptor: str) -> ADOResponse:
        """Get the user
    ...
    async def get_users(self) -> ADOResponse:
        """Get the users
    ...
    async def list_users_in_container(self, scope_descriptor: str) -> AsyncIterator[Any]:
