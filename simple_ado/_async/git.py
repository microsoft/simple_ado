...
class ADOAsyncGitClient(ADOAsyncBaseClient):
    ...
    async def all_repositories(self, project_id: str) -> ADOResponse:
    ...
    async def get_repository(self, *, project_id: str, repository_id: str) -> ADOResponse:
    ...
    async def get_status(self, *, sha: str, project_id: str, repository_id: str) -> ADOResponse:
    ...
    async def get_stats_for_branch(
    ...
    async def update_refs(
        ...
        *,
        ...
        response = await self.http_client.post(request_url, json_data=data)
        response_data = self.http_client.decode_response(response)
        return self.http_client.extract_value(response_data)
    ...
    async def get_blob(
        ...
        *,
        ...
        if blob_format == ADOAsyncGitClient.BlobFormat.TEXT:
            self.http_client.validate_response(response)
            return response.text

        if blob_format == ADOAsyncGitClient.BlobFormat.JSON:
            return self.http_client.decode_response(response)
