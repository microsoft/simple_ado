...
"""ADO governance API wrapper (async)."""
...
class ADOAsyncGovernanceClient(ADOAsyncBaseClient):
    ...
    class AlertSeverity(enum.Enum):
        ...
        @classmethod
        def _missing_(cls, value: Any) -> "ADOAsyncGovernanceClient.AlertSeverity":
            if value == "low":
                return cls(0)
            ...
            return cast("ADOAsyncGovernanceClient.AlertSeverity", super()._missing_(value))
    ...
    async def get_governed_repositories(self, *, project_id: str) -> dict[str, Any]:
    ...
    async def get_governed_repository(
    ...
    async def delete_governed_repository(
        self, *, governed_repository_id: str | int, project_id: str
    ) -> None:
    ...
    async def _set_alert_settings(
        ...
        *,
        ...
        response = await self.http_client.put(request_url, alert_settings)
    ...
    async def get_show_banner_in_repo_view(
        self, *, governed_repository_id: str | int, project_id: str
    ) -> bool:
        ...
        current_settings = await self.get_alert_settings(
    ...
    async def set_show_banner_in_repo_view(
        self,
        *,
        show_banner: bool,
        governed_repository_id: str | int,
    ...
    async def get_minimum_alert_severity(
        ...
        return ADOAsyncGovernanceClient.AlertSeverity(current_settings["minimumAlertSeverity"])

    async def set_minimum_alert_severity(
        self,
        *,
    ...
    async def set_work_item_settings(
        self,
        *,
