...
class ADOAsyncPoolsClient(ADOAsyncBaseClient):
    ...
    async def get_agent(self, *, pool_id: int, agent_id: int) -> ADOResponse:
        """Gets the agent details.
    ...
    async def update_agent(
        ...
        response = await self.http_client.patch(request_url, json_data=agent_data)
        return self.http_client.decode_response(response)

    async def set_agent_state(self, *, pool_id: int, agent_id: int, enabled: bool) -> ADOResponse:
        ...
        agent_details = await self.get_agent(pool_id=pool_id, agent_id=agent_id)
        agent_details["enabled"] = enabled
        return await self.update_agent(pool_id=pool_id, agent_id=agent_id, agent_data=agent_details)
    ...
    async def update_agent_capabilities(
        ...
        response = await self.http_client.put(request_url, json_data=capabilities)
        return self.http_client.decode_response(response)
