...
class ADOAsyncAuditClient(ADOAsyncBaseClient):
    ...
    async def get_actions(self, area_name: str | None = None) -> list[AuditActionInfo]:
    ...
    async def query(
        ...
        while True:
            ...
            for entry in decoded["decoratedAuditLogEntries"]:
                yield entry
